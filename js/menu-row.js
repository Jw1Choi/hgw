...
<nav class="top">
    <a class="logo"  target="_self" >
     <!-- <img id ="logo_img" src="../img/navi_book.png" onclick="window.location.href='../index.html'" style="width:30px;height:30px"> -->
      <p class="logo-font" id="lgt" style="" onclick="window.location.href='../index.html'">호관원 오늘의 이벤트</p>
      <!-- <img alt="" src="../img/logo_img.png" > -->
    
    </a>
    <div class="menu-btn">
        <button class="Event_Menu blink" style="padding-top:14px;"><a class="scroll mtext" href="#fm-box">오늘의 혜택 받기</a></button>
